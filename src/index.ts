...
import { openSettings, closeSettings, downloadExportFile, openFileToImportData, viewCommitOfCurrentVersion, showPromptToAskPersistentStorage } from './interface/settings/index';
...
window.bus = {
  ...
  settings: {
    ...
    showPromptToAskPersistentStorage
  }
};
