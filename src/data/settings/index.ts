...
var Settings = {
  time_formatting_mode: {
    ...
    icon: 'format',
    status: '',
    action: `openSettingsOptionsPage('time_formatting_mode')`,
    type: 'select',
    default_option: 0,
    option: 0,
    options: [
  ...
  display_current_location: {
    ...
    icon: 'location',
    status: '',
    action: `openSettingsOptionsPage('display_current_location')`,
    type: 'select',
    default_option: 1,
    option: 1,
    options: [
  ...
  refresh_interval: {
    ...
    icon: 'frequency',
    status: '',
    action: `openSettingsOptionsPage('refresh_interval')`,
    type: 'select',
    default_option: 0,
    option: 0,
    options: [
