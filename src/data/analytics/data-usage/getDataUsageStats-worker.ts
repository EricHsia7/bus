...
function processWorkerTask(data: data): DataUsageStats {
  ...
  const filling = `<linearGradient id="grad1" x1="50%" y1="0%" x2="50%" y2="100%"><stop offset="0%" style="stop-color:var(--b-cssvar-main-color-30-flattened);"></stop><stop offset="73%" style="stop-color:var(--b-cssvar-main-color-09-flattened);"></stop><stop offset="100%" style="stop-color:var(--b-cssvar-ffffff-blocky);"></stop></linearGradient>`;
