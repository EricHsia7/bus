...
export const MapVectorVersion = `${MapDataVersion}-27`;
export const MapRasterVersion = `${MapDataVersion}-27`;
export const MapLabelsVersion = `${MapDataVersion}-27`;
export const MapRoutesVersion = `${MapDataVersion}-23`;
