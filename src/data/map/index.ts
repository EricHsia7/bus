...
export const MapVectorVersion = `${MapDataVersion}-25`;
export const MapRasterVersion = `${MapDataVersion}-25`;
export const MapLabelsVersion = `${MapDataVersion}-25`;
export const MapRoutesVersion = `${MapDataVersion}-22`;
