...
export const MapVectorVersion = `${MapDataVersion}-24`;
export const MapRasterVersion = `${MapDataVersion}-24`;
export const MapLabelsVersion = `${MapDataVersion}-24`;
export const MapRoutesVersion = `${MapDataVersion}-21`;
