...
async function loadTile(tile: MapLoaderTile) {
  ...
  self.postMessage(
    ...
    [vectorPlan.coordinates.buffer, vectorPlan.descriptorStartIndices.buffer, vectorPlan.descriptorTypes.buffer, vectorPlan.partStartIndices.buffer, vectorPlan.styleReferences.buffer, vectorPlan.styleStartIndices.buffer, vectorPlan.palette.buffer, vectorPlan.gpu.polygonPositions.buffer, vectorPlan.gpu.polygonStyles.buffer, vectorPlan.gpu.polygonIndices.buffer, vectorPlan.gpu.lineVertices.buffer, vectorPlan.gpu.lineIndices.buffer, vectorPlan.gpu.palette.buffer, vectorPlan.gpu.styleData.buffer, labelPlan.sheet as ImageBitmap, labelPlan.bounds.buffer, labelPlan.features.buffer, labelPlan.glyphs.buffer, labelPlan.placements.buffer, labelPlan.scales.buffer, labelPlan.collisions.buffer, routePlan.features.buffer, routePlan.routeIds.buffer, routePlan.x.buffer, routePlan.y.buffer]
  );
}
