...
export function showPersonalScheduleCreator(pageTransitionReverse: boolean): void {
...
export function hidePersonalScheduleCreator(pageTransitionReverse: boolean): void {
