...
function generateElementOfEvent(event: object): GeneratedElement {
  ...
  element.style.setProperty('--b-calendar-event-top', `${60 * 24 * ((event.date.getTime() - thisDayStart.getTime()) / (24 * 60 * 60 * 1000))}px`);
  element.style.setProperty('--b-calendar-event-height', `${60 * 24 * ((event.duration * 60 * 1000) / (24 * 60 * 60 * 1000))}px`);
