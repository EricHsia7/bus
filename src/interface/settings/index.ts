...
import { getHTMLVersionBranchName, getTreeURLOfCurrentVersion } from '../../data/settings/version';
...
export function showBranchNameOfCurrentVersion(): void {
  promptMessage('graph_8', getHTMLVersionBranchName());
}
