...
const deviceData = [
  ...
  { device: 'iPhone 16 Pro Max', width: 440, height: 956, scaled_width: 1320, scaled_height: 2868 },
  { device: 'iPhone 16 Pro', width: 402, height: 874, scaled_width: 1206, scaled_height: 2622 },
  { device: 'iPhone 16 Plus', width: 430, height: 932, scaled_width: 1290, scaled_height: 2796 },
  { device: 'iPhone 16', width: 393, height: 852, scaled_width: 1179, scaled_height: 2556 },
...
async function processDeviceImage(deviceInfo, iconImage, backgroundImage) {
  ...
  const iconWidth = Math.max(Math.min(canvasWidth * 0.45, 160), 50) * scale;
